...
- User-safe error responses with reference IDs for support/debug

### Token Swaps
- Swap between supported stablecoins (USDC, EURC) on Arc Testnet
- Supports both directions: `USDC -> EURC` and `EURC -> USDC`
- Gas estimation and fee previews
- Transaction confirmation with explorer links

### Cross-Chain Bridge (CCTP)
- Bridge USDC from Arc Testnet to Ethereum Sepolia, Base Sepolia, and Arbitrum Sepolia
...
| AI | Anthropic Claude (Sonnet 5) | Natural language intent parsing |
...
- Node.js 20+
- A browser wallet (MetaMask, Rabby, or OKX)
...
|-------|----------|------------|
| USDC | Arc Testnet, Ethereum Sepolia, Base Sepolia, Arbitrum Sepolia | Swap, Bridge, Send |
